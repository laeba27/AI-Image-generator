"use client";
import { Wand2, Download } from "lucide-react"; // Import the Download icon
        ...
        {!activeImage || !prompt ? (
          ...
          <div className="mt-4 flex w-full max-w-4xl flex-col justify-center">
            <div className="relative">
              ...
              {/* Download Icon */}
              <button
                className="absolute top-2 right-2 p-4 bg-white bg-opacity-75 rounded-full shadow-lg hover:bg-opacity-100 transition"
                onClick={() =>
                  handleDownload(activeImage?.b64_json || "", "generated_image.png")
                }
              >
